...
const ForgotPasswordPage: React.FC = () => {
  const [selectedOption, setSelectedOption] = useState<"email" | "sms">(
    "email"
  );
        ...
        <div style={{ minHeight: "80vh" }}>
          <div className="flex items-center justify-end absolute top-0 right-0 m-6 mr-8">
            <button
              ...
              className="flex justify-start text-red-600 hover:text-red-700 hover:underline font-semibold text-ms "
            >
              Sign In
            </button>
          </div>
          ...
          <div className="flex-grow flex items-center justify-center w-full">
            <div className="bg-white text-black p-8 shadow-md w-full max-w-sm text-center">
              <h1 className="text-xl text-gray-800 text-left font-semibold mb-4">
                Email Sent
              </h1>
              <p className="mb-4 text-left text-sm">
                An email with instructions on how to reset your password has
                been sent to {email}. Check your spam or junk folder if you
