...
const HomePage = () => {
  ...
  useEffect(() => {
    ...
    const loadLikedContent = async () => {
      ...
      if (LikedContentResponse) {
        ...
        console.log("Not found likedContent");
      }
    };
    ...
    const loadMyListContent = async () => {
      ...
      if (MyListContentResponse) {
        ...
        console.log("Not found myListContent");
      }
    };
  ...
  // If user.profileId is null, return null to prevent rendering the rest of the page
  if (!user?.profileId) {
    return null;
  }
  ...
  return (
    <div className="z-60 -mt-36 bg-gradient-to-t from-black to-gray-900">
      ...
      >
        ...
        {/* TODO: This is The Last Breath Movie */}
      </div>
      <div className="absolute top-[50%] ml-4 md:ml-16">
        ...
        <div className="flex gap-3 flex-row items-center mt-3 md:mt-4">
          <button
            onClick={() => navigate(`/main-movie/play`)}
